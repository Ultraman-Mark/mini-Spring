...
public class DispatcherServlet extends HttpServlet {
    ...
    private void initHandlerMappings(AbstractApplicationContext context){
        ...
        for (String beanName : beanNames){
            ...
            //如果没有@controller标记则跳过
            if (!clazz.isAnnotationPresent(Controller.class)){
                continue;
            }

            //如果获取类中@RequestMapping标记，则需要获取请求地址的前缀
            String baseUrl = "";
     ...
     * <p>初始化适配器</p>
     * */
    public void initHandlerAdapters(AbstractApplicationContext context){
     ...
     * 初始化视图解析器
     * */
    public void initViewResolvers(AbstractApplicationContext context){
        //默认扫描"/template"目录
